...
def saida(nome,id,url,ataque,vida,defesa): 
    ...
    layout = [
        [sg.Text("Pokédex",justification='center',size=(100,1), font=("Roboto, 30"),text_color='#FFF',background_color='#FA0303')],
    ...
    window = sg.Window("Pokédex", layout, size=(350, 500), background_color='#FA0303',grab_anywhere=True)
